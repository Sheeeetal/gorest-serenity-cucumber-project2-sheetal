...
public class PropertyReader {
    ...
    private static volatile groovy.beans.PropertyReader propInstance;
     ...
     */
    public static synchronized groovy.beans.PropertyReader getInstance(){
        if (propInstance == null){
            propInstance = new groovy.beans.PropertyReader();
        }
        return propInstance;
    }
